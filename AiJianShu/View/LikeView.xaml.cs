...
{
    public sealed partial class LikeView : UserControl
    {
        #region 字段
        //标志位:标志文章内容部分是否打开过
        ...
        public LikeView()
        {
            ...
            Loaded += LikeViewLoaded;
            if (Windows.Foundation.Metadata.ApiInformation.IsTypePresent("Windows.Phone.UI.Input.HardwareButtons"))
            {
                this.Unloaded += LikeViewUnloaded;
                Windows.Phone.UI.Input.HardwareButtons.BackPressed += HardwareButtonsBackPressed;
            }
        }

        private void LikeViewUnloaded(object sender, RoutedEventArgs e)
        {
            Windows.Phone.UI.Input.HardwareButtons.BackPressed -= HardwareButtonsBackPressed;
        }
        #endregion
        ...
        private void LikeViewLoaded(object sender, RoutedEventArgs e)
        {
